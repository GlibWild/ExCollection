...
namespace ExCollection
{
    public static class ExZip
    {
        ...
        /// <summary>
        /// 将传入对象先序列化以GZip算法压缩后，返回Base64编码字符
        /// </summary>
        /// <param name="rawString">需要压缩的字符串</param>
        /// <returns>压缩后的Base64编码的字符串</returns>
        public static string GZipCompressObject<T>(this T model)
        {
            string rawString = "";
            if (model == null)
            {
            ...
            {
                rawString = JsonSerializer.Serialize(model);
                return GZipCompressString(rawString);
            }
        }
        ...
        public static string GZipDecompressString(this string zippedString)
        {
            ...
            else
            {
                ...
                return (string)(System.Text.Encoding.UTF8.GetString(zippedData.Decompress()));
            }
        }
        /// <summary>
        /// ZIP解压
